...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *FlightKit.DataAccess.Api*):

Restore dependencies
```
    cd "FlightKit.DataAccess.Api"
    dotnet restore
```

Execute unit tests
```
    cd "FlightKit.DataAccess.Api/test/FlightKit.DataAccess.Api.Tests"
    dotnet test
```

Deploy application
```
    cd "FlightKit.DataAccess.Api/src/FlightKit.DataAccess.Api"
